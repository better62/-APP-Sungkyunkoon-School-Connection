...
public class PostActivity_person extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.et_person_title);
        content = findViewById(R.id.et_person_content);
        btn_save = findViewById(R.id.btn_person_save);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //btn_save 버튼을 누르면 id(사용자 UID),title, content가 클라우드 파이어스토어에 저장된다
                if (auth.getCurrentUser()!=null) {
                    String postId = firestore.collection("post_person").document().getId(); //document():Returns a DocumentReference pointing to a new document with an auto-generated ID within this collection
